// Small inline icons (stroke = currentColor) so they inherit text colour.
type P = { size?: number };
const base = (size = 16) => ({
  width: size,
  height: size,
...
export const ClipboardIcon = ({ size }: P) => (
  <svg {...base(size)}>
...
// Source markers for history rows.
export const FileMark = ({ size }: P) => (
  <svg {...base(size)}>
